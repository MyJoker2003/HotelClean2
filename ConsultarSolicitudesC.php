...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="indexConserje.php">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="ConsultarSolicitudesC.php">Consultar Solicitud</a>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $myconsulta = "SELECT * FROM solicitudconserje JOIN solicitud USING (id_solicitud) WHERE id_conserje = '$usuario' AND estado = 'pendiente'";
                                                        ...
                                                        if($rows > 0){
                                                            ...
                                                            echo "<tr><td align='center' colspan='6'>NO tienes solicitudes asignadas</td></tr>";
                                                        }
