...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="indexConserje.php">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">OPERACIONES:</h6>
                        <a class="collapse-item active" href="reportesC.php">Nuevo Reporte</a>
                    </div>
                </div>
            </li>
                                        ...
                                        <div>
                                            ...
                                            <form id="formulario-limpieza">
                                                <div class="form-group">
                                                    <input type="text" class="form-control d-none" id="id-conserje" name="id-conserje" value="<?php echo $usuario; ?>" readonly>
                                                </div>
                                                <!--Select: TIPO AREA-->
                                                <div class="form-group">
